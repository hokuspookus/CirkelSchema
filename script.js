...
const url = 'https://schemaapi.hokuspookus.repl.co/get/lessons';
...
function getCurrentLesson() {
    ...
    try {
        lessons.forEach(element => {
            let lessonStart = parseInt(element['timeStart'].split(':')[0]*60) + parseInt(element['timeStart'].split(':')[1]);
            let lessonEnd = parseInt(element['timeEnd'].split(':')[0]*60) + parseInt(element['timeEnd'].split(':')[1]);
